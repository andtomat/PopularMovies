...
public final class FitImageView extends AppCompatImageView {
    ...
    public FitImageView(Context context, AttributeSet attrs) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FitImageView);
        aspectRatio = a.getFloat(R.styleable.FitImageView_imageAspectRatio, 0);
        a.recycle();
    }
